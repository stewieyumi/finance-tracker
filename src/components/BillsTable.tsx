                  ...
                  {isEditing ? (
                    <div className="space-y-2">
                        <input
                          ...
                          className="bg-[#0b0b0d] border border-zinc-700 rounded-lg px-2.5 py-1.5 text-white text-xs w-full outline-none disabled:opacity-50 disabled:cursor-not-allowed"
                        />                      
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        />
                          <select
                            ...
                            disabled={editScope === "monthOnly"}
                            className="bg-[#0b0b0d] border border-zinc-700 rounded-lg px-2 py-1.5 text-white text-xs disabled:opacity-50 disabled:cursor-not-allowed"
                          >                          
                    ...
                    <td className="py-2.5 px-2 align-top pt-3 text-zinc-200 truncate font-medium">
                      {isEditing ? (
                          <input
                            ...
                            onChange={(e) => setEditForm({ ...editForm, name: e.target.value })}
                            disabled={editScope === "monthOnly"}
                            className="bg-[#0b0b0d] border border-zinc-700 rounded-lg px-2 py-1 text-white text-xs w-full focus:ring-1 focus:ring-blue-500 outline-none disabled:opacity-50 disabled:cursor-not-allowed"
                          />
                      ) : (
                      ...
                      {isEditing ? (
                        <div className="flex flex-col gap-1.5">
                          <select
                            ...
                            onChange={(e) => setEditForm({ ...editForm, type: e.target.value as BillType })}
                            disabled={editScope === "monthOnly"}
                            className="bg-[#0b0b0d] border border-zinc-700 rounded-lg px-2 py-1 text-white text-xs w-full disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                              <option value="Bill">Bill</option>
                            <option value="Subscription">Subscription</option>
                            <option value="Loan / Installment">Loan / Installment</option>
                        ...
                        <div className="grid grid-cols-2 gap-1">
                          <select
                            value={editForm.startMonth || selectedMonth}
                            onChange={(e) => setEditForm({ ...editForm, startMonth: e.target.value })}
                            disabled={editScope === "monthOnly"}
                            className="bg-[#0b0b0d] border border-zinc-700 rounded px-1 py-0.5 text-white text-[10px] disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                          ...
                          <select
                            value={editForm.endMonth || selectedMonth}
                            onChange={(e) => setEditForm({ ...editForm, endMonth: e.target.value })}
                            disabled={editScope === "monthOnly"}
                            className="bg-[#0b0b0d] border border-zinc-700 rounded px-1 py-0.5 text-white text-[10px] disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            {ALL_MONTH_YEAR_OPTIONS.map(m => (
                        ...
                        <div className="flex flex-col gap-2">
                          <div className="flex items-center gap-1.5 flex-wrap">
                            ...
                            {(() => {
                              ...
                              const { text, tone } = formatDaysRemaining(bill.daysLeft);
                              return (
