...
import { filterBills, sortBills, groupBillsByHalfMonth, BillSortOption } from "../utils/bills/billListHelpers";
...
export const BillsTable: React.FC<BillsTableProps> = React.memo(({
  ...
  const { firstHalf: firstHalfBills, secondHalf: secondHalfBills } = useMemo(() => groupBillsByHalfMonth(sortedBills), [sortedBills]);
