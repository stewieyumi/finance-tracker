    ...
    <div className="space-y-5 sm:space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 ease-[cubic-bezier(0.32,0.72,0,1)]">
      ...
      <div className="bg-surface-low border border-inverse/[0.08] rounded-2xl p-5 shadow-xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-3 py-4">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-blue-500/10 to-purple-500/10 dark:from-blue-500/20 dark:to-purple-500/20 border border-purple-500/30 flex items-center justify-center mb-2 shadow-[0_0_20px_rgba(168,85,247,0.2)]">
            <ScanLine size={24} className="text-purple-600 dark:text-purple-400" />
          </div>
